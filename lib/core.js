// TODO transferring to fake.js and other objects
...
//   var name = options.name || 'Fake',
  ...
  //     var methodName = method,
      ...
      // calls.storasOwnProperty(method)) {
      //     Object.defineProperty(this, method, {
      //       get: function () { return this[methodName](); },
      //       set: fue(method, args, lastCallDetails);

      // if (options.property) {
      //   methodName = method + '_property';
      //   if (!this.hnction (value) { this[methodName](value); }
      //     });
      //   }
      // }
